// Don't forget to create symlink to this file at dwm/config.h

// This is not included by default. Needed for keys like XF86AudioRaiseVolume.
// By the way, what xev shows is not the same as what this file defines. So the
// key becomes XF86XK_AudioRaiseVolume.
...
static Key keys[] = {
	...
	//{ MODKEY,                       XK_e,      some_print_function,          { 0 } },
	{ MODKEY,                       XK_p,      spawn,          {.v = dmenucmd } },
	{ MODKEY|ShiftMask,             XK_Return, spawn,          {.v = termcmd } },

	{ Mod1Mask|ControlMask,         XK_l,      spawn,         {.v = mycmdslaunchercmd } }, // l for "launch" frequently used cmds
	{ 0,                            XK_Menu,   spawn,         {.v = mycmdslaunchercmd } }, // or the Menu key
	...
	{ MODKEY,                       XK_j,      focusstack,     {.i = +1 } },
                                                                //{ MODKEY,                       XK_j,      some_print_function,          { 0 } },
	{ MODKEY,                       XK_k,      focusstack,     {.i = -1 } },
                                                                //{ MODKEY,                       XK_k,      some_print_function,          { 0 } },
